...
export class SupabaseSignalingAdapter<
	T extends SignalingMessage,
> extends AbstractSignalingAdapter<T> {
	...
	private handleSignalBroadcast(payload: { payload: RTCSignalingMessage }): void {
